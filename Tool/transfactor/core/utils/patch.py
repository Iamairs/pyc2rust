...
```
    """
    content = ""
    for message in [create_file_without_content_message, create_file_with_content_message, insert_file_message, update_file_message, delete_file_message]:
        changes = extract_code_block_change_info(message)
        print(changes)
        content = apply_changes(content, changes["file.rs"])
        print(content)
        print("=====================================")
