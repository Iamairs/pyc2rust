...
def update_cargo_toml(project_path: str, section: str, key: str, value: str | int | float | bool | list | dict):
    """更新 Cargo.toml 文件中的指定字段"""
    cargo_toml_path = os.path.join(project_path, "Cargo.toml")
    with open(cargo_toml_path, "r") as f:
        cargo_toml_content = f.read()
    data = toml.loads(cargo_toml_content, _dict=OrderedDict)
